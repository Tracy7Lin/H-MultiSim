...
class DCCNN(nn.Module):
    def __init__(self, in_features=1, num_classes=5):
        super().__init__()
        self.conv1 = nn.Sequential(
            nn.Conv2d(in_features, 8, kernel_size=5, stride=1, padding=0),
            nn.ReLU(inplace=True),
